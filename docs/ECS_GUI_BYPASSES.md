...
| 5 | Workspace m_savedItems / freeze→Color | **2177** restore; **2194** snapshot Placement-only; **2195** rememberItemState Placement-only; persist/bind keep durable Color over lag; **2212** updateWorkspaceSavedAppearance Placement-only (no content dual-write) |
