...
Latest agent handoff: **TODO.md → “Plan / work (2026-09-03) — bundle qimgview-111-gallery-select-perf”**
(Gallery selection no longer sync-decodes for hidden metadata dock). Next bundle number: **112**.
