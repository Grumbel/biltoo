...
Latest agent handoff: **TODO.md → biltoo-2584.1-export-display-pipeline**.
Latest tip: **biltoo-2584** (+ thumtoo-338). Pipeline owns blocking export display materialize.
