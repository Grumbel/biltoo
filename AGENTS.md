...
Latest agent handoff: **TODO.md → biltoo-2475.2-drop-unused-frame-size-helper**.
Latest tip: **biltoo-2475.2** (+ thumtoo-338). Drop unused itemHasReliableFrameSize on ImageView.
