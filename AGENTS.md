...
Latest agent handoff: **TODO.md → biltoo-1025-tilelod-core**.
Next bundle number: **1026**
**Tile LOD:** [docs/TILE_LOD.md](docs/TILE_LOD.md) — Qt-free `src/tilelod/`; LQIP underlay until first tile.
