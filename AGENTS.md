...
Latest agent handoff: **TODO.md → biltoo-2593.1-capture-persist-policy**.
Latest tip: **biltoo-2593** (+ thumtoo-338). SessionAppearance owns capture assemble + path persist.
