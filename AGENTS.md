...
Latest agent handoff: **TODO.md → biltoo-2524.1-fix-angleAt-workspace-rotate**.
Latest tip: **biltoo-2524** (+ thumtoo-338). Workspace rotate uses PlacementLinear; drop angleAt.
