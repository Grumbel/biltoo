...
Latest agent handoff: **TODO.md → biltoo-2480.2-fix-text-recompute-decl**.
Latest tip: **biltoo-2480.2** (+ thumtoo-338). Fix: drop undeclared recomputeTextSearchMatches router.
