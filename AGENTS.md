...
Latest agent handoff: **TODO.md → biltoo-1054-tilelod-gallery-cell-threshold**.
Next bundle number: **1055**
**Tile LOD:** [docs/TILE_LOD.md](docs/TILE_LOD.md) — gallery cell threshold; crop-draft suppress; graded cache; [TILE_LOD_RUNTIME.md](docs/TILE_LOD_RUNTIME.md).
