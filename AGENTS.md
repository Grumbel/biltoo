...
Latest agent handoff: **TODO.md → biltoo-1071-tilelod-min-scale-clamp-test**.
Next bundle number: **1072**
**Tile LOD:** [docs/TILE_LOD.md](docs/TILE_LOD.md) — min_scale test; tick priority; [TILE_LOD_RUNTIME.md](docs/TILE_LOD_RUNTIME.md).
