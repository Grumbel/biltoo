...
Latest agent handoff: **TODO.md → biltoo-1044-tilelod-parent-prefetch**.
Next bundle number: **1045**
**Tile LOD:** [docs/TILE_LOD.md](docs/TILE_LOD.md) — parent stand-in prefetch; [TILE_LOD_RUNTIME.md](docs/TILE_LOD_RUNTIME.md).
