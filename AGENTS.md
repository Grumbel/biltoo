...
Latest agent handoff: **TODO.md → biltoo-2587.1-workspace-canvas-place**.
Latest tip: **biltoo-2587** (+ thumtoo-338). Workspace owns addImageForSession + placeOrMoveImageAt.
