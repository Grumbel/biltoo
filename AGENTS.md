...
Latest agent handoff: **TODO.md → qimgview-163-fade-black-position**
(Fade through black: cover underlay with from/to blits; no position jump).
Next bundle number: **164**.
