...
Latest agent handoff: **TODO.md → biltoo-1035-tilelod-skip-prefercache**.
Next bundle number: **1036**
**Tile LOD:** [docs/TILE_LOD.md](docs/TILE_LOD.md) — PreferCache skipped in tile band; [TILE_LOD_RUNTIME.md](docs/TILE_LOD_RUNTIME.md).
