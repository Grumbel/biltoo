...
Latest agent handoff: **TODO.md → biltoo-1046-tilelod-free-rot-maps**.
Next bundle number: **1047**
**Tile LOD:** [docs/TILE_LOD.md](docs/TILE_LOD.md) — free-rot crop maps; [TILE_LOD_RUNTIME.md](docs/TILE_LOD_RUNTIME.md).
