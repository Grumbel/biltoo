...
Latest agent handoff: **TODO.md → biltoo-2305 + docs/ACTIVITY.md (status plan)**.
Latest tip: **biltoo-2305-gallery-layout-early-pack** (code). Docs: **ACTIVITY.md**. Next code bundle: **2306**
