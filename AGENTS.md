...
Latest agent handoff: **TODO.md → biltoo-1027-tilelod-tick-outside-paint**.
Next bundle number: **1028**
**Tile LOD:** [docs/TILE_LOD.md](docs/TILE_LOD.md) — tiles own deep zoom; PreferCache only below soft max.
