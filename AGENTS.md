...
Latest agent handoff: **TODO.md → biltoo-1036-tilelod-coverage-idle**.
Next bundle number: **1037**
**Tile LOD:** [docs/TILE_LOD.md](docs/TILE_LOD.md) — coverage idle timer; [TILE_LOD_RUNTIME.md](docs/TILE_LOD_RUNTIME.md).
