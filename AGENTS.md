...
Latest agent handoff: **TODO.md → biltoo-1051-tilelod-graded-cache**.
Next bundle number: **1052**
**Tile LOD:** [docs/TILE_LOD.md](docs/TILE_LOD.md) — graded tile paint cache; [TILE_LOD_RUNTIME.md](docs/TILE_LOD_RUNTIME.md).
