...
Latest agent handoff: **TODO.md → biltoo-1073-tilelod-zoom-gui-perf**.
Next bundle number: **1074**
**Tile LOD:** [docs/TILE_LOD.md](docs/TILE_LOD.md) — zoom GUI perf; parent UV; [TILE_LOD_RUNTIME.md](docs/TILE_LOD_RUNTIME.md).
