...
Latest agent handoff: **TODO.md → biltoo-1069-tilelod-gallery-tick-priority**.
Next bundle number: **1070**
**Tile LOD:** [docs/TILE_LOD.md](docs/TILE_LOD.md) — gallery tick priority; min_scale; [TILE_LOD_RUNTIME.md](docs/TILE_LOD_RUNTIME.md).
