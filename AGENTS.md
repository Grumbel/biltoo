...
Latest agent handoff: **TODO.md → biltoo-1038-tilelod-cache-budget**.
Next bundle number: **1039**
**Tile LOD:** [docs/TILE_LOD.md](docs/TILE_LOD.md) — 128MiB shared cache budget; [TILE_LOD_RUNTIME.md](docs/TILE_LOD_RUNTIME.md).
