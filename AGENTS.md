...
Latest agent handoff: **TODO.md → biltoo-1050-tilelod-color-grade-paint**.
Next bundle number: **1051**
**Tile LOD:** [docs/TILE_LOD.md](docs/TILE_LOD.md) — color grade at tile paint; [TILE_LOD_RUNTIME.md](docs/TILE_LOD_RUNTIME.md).
