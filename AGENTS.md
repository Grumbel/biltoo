...
Latest agent handoff: **TODO.md → biltoo-1039-tilelod-zoomout-drop-debug**.
Next bundle number: **1040**
**Tile LOD:** [docs/TILE_LOD.md](docs/TILE_LOD.md) — zoom-out drop finer; BILTOO_TILE_DEBUG; [TILE_LOD_RUNTIME.md](docs/TILE_LOD_RUNTIME.md).
