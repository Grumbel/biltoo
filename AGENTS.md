...
Latest agent handoff: **TODO.md → biltoo-232-slideshow-clock-sync**
(Clock/index sync: absolute pending to-index; lag recovery; no goNext on finish).
Next bundle number: **233**.
