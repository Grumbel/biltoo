...
Latest agent handoff: **TODO.md → biltoo-1058-tilelod-fetch-bitmap-no-qimage**.
Next bundle number: **1059**
**Tile LOD:** [docs/TILE_LOD.md](docs/TILE_LOD.md) — fetch TileBitmap; leave-band; tick throttle; [TILE_LOD_RUNTIME.md](docs/TILE_LOD_RUNTIME.md).
