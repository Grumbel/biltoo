...
Latest agent handoff: **TODO.md → biltoo-2206-image-create-layout-matches-install**.
Latest tip: **biltoo-2206-image-create-layout-matches-install**. Next bundle number: **2207**
