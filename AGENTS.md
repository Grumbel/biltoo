...
Latest agent handoff: **TODO.md → biltoo-1074-tilelod-debug-overlay-kinds**.
Next bundle number: **1075**
**Tile LOD:** [docs/TILE_LOD.md](docs/TILE_LOD.md) — overlay EXACT/PARENT/HOLE; [TILE_LOD_RUNTIME.md](docs/TILE_LOD_RUNTIME.md).
