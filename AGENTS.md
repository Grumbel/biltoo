...
Latest agent handoff: **TODO.md → biltoo-2453.1-pipeline-host-only-no-view**.
Latest tip: **biltoo-2453** (+ thumtoo-338). Phase 5 CLOSED; pipeline bound only to DisplayPipelineHost (no view()).
