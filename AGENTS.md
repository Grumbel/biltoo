...
Latest agent handoff: **TODO.md → biltoo-2461.1-fix-dual-per-surface-pipeline**.
Latest tip: **biltoo-2461** (+ thumtoo-338). Dual: per-surface pipeline (secondary was black).
