...
Latest agent handoff: **TODO.md → biltoo-1630-path-order-occurrences-view-only**.
Latest tip: **biltoo-1630-path-order-occurrences-view-only**. Next bundle number: **1631**
