...
Latest agent handoff: **TODO.md → biltoo-1031-tilelod-scale-hold**.
Next bundle number: **1032**
**Tile LOD:** [docs/TILE_LOD.md](docs/TILE_LOD.md) — scale hold; [TILE_LOD_RUNTIME.md](docs/TILE_LOD_RUNTIME.md).
