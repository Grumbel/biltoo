...
Latest agent handoff: **TODO.md → biltoo-1030-tilelod-hidpi-cancel-once**.
Next bundle number: **1031**
**Tile LOD:** [docs/TILE_LOD.md](docs/TILE_LOD.md) — HiDPI density; PreferCache cancel once per path.
