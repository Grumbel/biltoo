...
Latest agent handoff: **TODO.md → biltoo-1062-tilelod-durable-tiles-memo**.
Next bundle number: **1063**
**Tile LOD:** [docs/TILE_LOD.md](docs/TILE_LOD.md) — durable-tiles memo; durable gate; source epoch; [TILE_LOD_RUNTIME.md](docs/TILE_LOD_RUNTIME.md).
