...
Latest agent handoff: **TODO.md → biltoo-2592.1-fix-workspace-place-access**.
Latest tip: **biltoo-2592** (+ thumtoo-338). Fix workspace place LoadAdd / private host access.
