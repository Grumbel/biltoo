...
Latest agent handoff: **TODO.md → biltoo-2569.1-own-crop-restore-gallery-enter**.
Latest tip: **biltoo-2569** (+ thumtoo-338). Own crop restore source + gallery enter layout.
