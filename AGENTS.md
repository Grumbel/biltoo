...
Latest agent handoff: **TODO.md → biltoo-1049-tilelod-skip-color-grade**.
Next bundle number: **1050**
**Tile LOD:** [docs/TILE_LOD.md](docs/TILE_LOD.md) — skip tiles when color-graded; [TILE_LOD_RUNTIME.md](docs/TILE_LOD_RUNTIME.md).
