...
Latest agent handoff: **TODO.md → biltoo-239-slideshow-nav-hud**
(Single arm on nav; per-slide HUD; retry beginLive instead of snapshot jump).
Next bundle number: **240**.
