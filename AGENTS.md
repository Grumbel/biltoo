...
Latest agent handoff: **TODO.md → biltoo-2595.1-session-id-persist-slot**.
Latest tip: **biltoo-2595** (+ thumtoo-338). ImageController owns setItemSessionId + persistSessionAppearanceSlot.
