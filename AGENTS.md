...
Latest agent handoff: **TODO.md → biltoo-1061-tilelod-require-durable-tiles**.
Next bundle number: **1062**
**Tile LOD:** [docs/TILE_LOD.md](docs/TILE_LOD.md) — durable-tiles gate; source epoch; identity cache; [TILE_LOD_RUNTIME.md](docs/TILE_LOD_RUNTIME.md).
