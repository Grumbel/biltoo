...
Latest agent handoff: **TODO.md → biltoo-2601.1-façade-only-root**.
Latest tip: **biltoo-2601** (+ thumtoo-338). ImageView method TUs sorted into domain imageview_routers.cpp.
