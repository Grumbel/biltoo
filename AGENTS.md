...
Latest agent handoff: **TODO.md → biltoo-2527.1-fix-ensureVisible-own-session-nav**.
Latest tip: **biltoo-2527** (+ thumtoo-338). ensureVisible fix; session-nav on ImageController.
