...
Latest agent handoff: **TODO.md → biltoo-2522.1-fix-transform-reset-thin**.
Latest tip: **biltoo-2522** (+ thumtoo-338). Fix transform reset signatures; attention session change; thin routers.
