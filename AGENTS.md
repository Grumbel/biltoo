...
Latest agent handoff: **TODO.md → biltoo-1064-tilelod-content-size-idempotent**.
Next bundle number: **1065**
**Tile LOD:** [docs/TILE_LOD.md](docs/TILE_LOD.md) — content-size idempotent; durableTilesReady; [TILE_LOD_RUNTIME.md](docs/TILE_LOD_RUNTIME.md).
