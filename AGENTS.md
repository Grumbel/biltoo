...
Latest agent handoff: **TODO.md → biltoo-1045-tilelod-prefercache-gates**.
Next bundle number: **1046**
**Tile LOD:** [docs/TILE_LOD.md](docs/TILE_LOD.md) — PreferCache gates all modes; [TILE_LOD_RUNTIME.md](docs/TILE_LOD_RUNTIME.md).
