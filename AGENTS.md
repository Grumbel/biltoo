...
**Host pixels:** [docs/PIXEL_HOST_CACHE.md](docs/PIXEL_HOST_CACHE.md).
...
Latest agent handoff: **TODO.md → biltoo-1055-tilelod-failed-nospam-generation**.
Next bundle number: **1056**
**Tile LOD:** [docs/TILE_LOD.md](docs/TILE_LOD.md) — failed no-spam generation; gallery threshold; crop-draft; [TILE_LOD_RUNTIME.md](docs/TILE_LOD_RUNTIME.md).
