...
Latest agent handoff: **TODO.md → biltoo-1026-tilelod-thumtoo-image**.
Next bundle number: **1027**
**Tile LOD:** [docs/TILE_LOD.md](docs/TILE_LOD.md) — `tilelod` + ThumtooTileSource + ImageItem deep-zoom paint.
