...
Latest agent handoff: **TODO.md → biltoo-1029-tilelod-shared-path-cache**.
Next bundle number: **1030**
**Tile LOD:** [docs/TILE_LOD.md](docs/TILE_LOD.md) — shared path cache; per-item viewports.
