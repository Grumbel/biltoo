...
Latest agent handoff: **TODO.md → “Plan / work (2026-09-04) — bundle qimgview-136-zoom-with-motion”**
(Slideshow zoom is base scale for dwell camera, not only when motion is Off).
Next bundle number: **137**.
