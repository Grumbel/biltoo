...
Latest agent handoff: **TODO.md → biltoo-2585.1-probed-size-pipeline**.
Latest tip: **biltoo-2585** (+ thumtoo-338). Pipeline owns applyProbedImageSize; modes includes slimmed.
