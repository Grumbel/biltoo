...
Latest agent handoff: **TODO.md → biltoo-1028-tilelod-image-workspace-fix**.
Next bundle number: **1029**
**Tile LOD:** [docs/TILE_LOD.md](docs/TILE_LOD.md) — Image+Workspace; PreferCache cancelled in tile band.
