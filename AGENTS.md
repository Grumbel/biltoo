...
Latest agent handoff: **TODO.md → biltoo-1048-tilelod-destroy-clear-inflight**.
Next bundle number: **1049**
**Tile LOD:** [docs/TILE_LOD.md](docs/TILE_LOD.md) — destroy clears shared InFlight; [TILE_LOD_RUNTIME.md](docs/TILE_LOD_RUNTIME.md).
