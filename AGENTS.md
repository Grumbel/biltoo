...
Latest agent handoff: **TODO.md → biltoo-1070-tilelod-workspace-tick-priority**.
Next bundle number: **1071**
**Tile LOD:** [docs/TILE_LOD.md](docs/TILE_LOD.md) — workspace/gallery tick priority; [TILE_LOD_RUNTIME.md](docs/TILE_LOD_RUNTIME.md).
