...
- **CropGeometry** (`cropgeometry.{h,cpp}`): pure crop-rect constrain/translate/shrink; axisAlignedOutside + priorDraftNeedsExpand; CropButtonLayout chrome placement; no ImageView state.
