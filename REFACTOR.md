...
- **CropGeometry** (`cropgeometry.{h,cpp}`): pure crop-rect constrain/translate/shrink; axisAlignedOutside + priorDraftNeedsExpand; CropButtonLayout; frameViewAnchors + hitTestCropChrome; no ImageView state.
