...
| Applied `ContentXform` fingerprint | Mid-edit content authority | ItemWorld when bound (2080–2082); CropSession takes applied from view; ImageItem mirror for paint / unbound |
