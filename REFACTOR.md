...
- **CropGeometry** (`cropgeometry.{h,cpp}`): pure crop-rect constrain/translate/shrink; axisAlignedOutside + priorDraftNeedsExpand for Expand-on-reenter; no ImageView state.
